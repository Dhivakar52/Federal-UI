...
export const MenuProvider = ({ children }) => {
  ...
  //   { icon: <IdCard size={20} />, activeIcon: <IdCard color="black" size={20} />, label: "Profile", path: "/account" },
  // ];
  ...
  const menuItems = [
  {
    ...
    activeIcon: <TrendingUp color="black" size={20} />,
    label: "Trends",
    path: "/trends"
  },
  {
    icon: <Newspaper color="white" size={20} />,
    activeIcon: <Newspaper color="black" size={20} />,
    label: "Summarize",
    path: "/summary"
  },
  {
    icon: <BookOpen color="white" size={20} />,
    activeIcon: <BookOpen color="black" size={20} />,
    label: "FlashCard",
    path: "/flashcard"
  },
  {
    icon: <Users color="white" size={20} />,
    activeIcon: <Users color="black" size={20} />,
    label: "Peer News",
    path: "/peer"
  },
  {
    icon: <Columns color="white" size={20} />,
    activeIcon: <Columns color="black" size={20} />,
    label: "Press Pivot",
    path: "/press-pivot"
  },
  {
  ...
  },
  {
    ...
    activeIcon: <LayoutGrid color="black" size={20} />,
    label: "Editorial Mosaic",
    path: "/editor-mosaic"
  },
  {
    icon: <MessageSquare color="white" size={20} />,
    activeIcon: <MessageSquare color="black" size={20} />,
